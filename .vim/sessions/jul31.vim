...
silent only
cd /var/www/html/vendors/products/add
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +2 verify/index.php
badd +36 /var/www/includes/sitefunctions.php
badd +156 ../../register/index.html
badd +11 verify/saveData.php
badd +40 verify/evaluate.php
badd +45 done/index.php
badd +10 ~/.vimrc
args evaluate/index.php
edit done/index.php
...
silent! normal! zE
let s:l = 93 - ((17 * winheight(0) + 22) / 45)
